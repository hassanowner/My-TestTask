...
/*
----------------------------------------
EXAMPLE 1: VERY SIMPLE GET REQUEST
----------------------------------------
This is the most basic usage of fetch().
It simply loads a file and prints the result.
*/
...
/*
----------------------------------------
EXAMPLE 2: MORE ADVANCED GET REQUEST
----------------------------------------
This example checks the HTTP status and
handles errors more carefully.
*/
...
/*
----------------------------------------
EXAMPLE 3: FULL EXAMPLE FROM THE EXPLANATION
----------------------------------------
This example loads JSON data and builds
HTML content based on the response.
*/
...
/*
----------------------------------------
EXAMPLE 1: VERY SIMPLE ASYNC / AWAIT GET
----------------------------------------
*/
...
/*
----------------------------------------
EXAMPLE 2: MORE ADVANCED ASYNC / AWAIT GET
----------------------------------------
